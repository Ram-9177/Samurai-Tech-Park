...
import { FaGraduationCap, FaCode, FaRocket, FaPlay, FaDownload, FaEnvelope, FaArrowRight, FaWhatsapp, FaCheckCircle, FaLightbulb, FaHandshake, FaAward, FaGlobe, FaDatabase, FaCloud, FaMobile, FaDesktop, FaShieldAlt, FaChartLine, FaCog, FaRobot } from 'react-icons/fa'
